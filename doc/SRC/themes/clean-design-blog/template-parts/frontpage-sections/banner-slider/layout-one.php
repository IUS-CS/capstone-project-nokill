<?php
/**
 * Template parts - layout one "Banner slider"
 * 
...
?>
<div class="bmm-banner-slider-block-wrap">
    <div class="bmm-banner-slider-block bmm-block bmm-block-banner-slider--layout-one" <?php echo esc_attr( $sliderAttr ); ?>>
        <?php
            ...
            ?>
                    <div class="banner-slider-item <?php if( ! has_post_thumbnail() ) echo 'no-thumb'; ?>">
